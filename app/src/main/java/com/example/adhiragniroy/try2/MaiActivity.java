...
public class MaiActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(MaiActivity.this, Main4Activity.class);
                startActivity(i);
            }
        });
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_first_layout) {
            ...
            Intent a = new Intent(MaiActivity.this, aboutfragment.class);
            startActivity(a);
        } else if(id==R.id.nav_send){
            Intent b = new Intent(MaiActivity.this, FeedFragment.class);
            startActivity(b);
        }
